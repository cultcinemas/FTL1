...
class Var(object):
    AUTH_USERS = '5685802336 5452354891 5602172369 1392184089' # Add id of users you want to authorize to use the bot. Separated by spaces
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '7386512270:AAF_szBwnRs5neTpBAWQAOz91cKigxYh9HE'))
